  ...
  return (
    ...
    >
      ...
      {image && (
        <div className="relative h-48 overflow-hidden rounded-t-xl">
          ...
          <div className="absolute bottom-4 left-4">
            <div className="w-12 h-12 rounded-xl bg-accent flex items-center justify-center text-primary shadow-lg">
              {icon}
            </div>
          </div>
        </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* Details as bullets */}
        <ul className="text-sm text-foreground/70 mb-6 flex-grow space-y-1">
        ...
        {/* CTA Button */}
        <a
          href={`https://wa.me/97430773176?text=${whatsappMessage}`}
          target="_blank"
